...
INSERT INTO Ask (cellphoneClient, cellphoneDriver, initialCoordinates, finalCoordinates, initialTime, finalTime, stars, pay) VALUES
	...
	(3107307371, 3102222222, GEOMETRY(POINT(1,2)), GEOMETRY(POINT(1,3)), (TIMESTAMP '2019-03-08T08:00:12.772Z'), (TIMESTAMP '2019-03-08T08:30:12.772Z'), 5, false),
	(3107307371, 3102222222, GEOMETRY(POINT(1,2)), GEOMETRY(POINT(1,3)), (TIMESTAMP '2019-03-09T08:00:00.772Z'), (TIMESTAMP '2019-03-09T09:45:28.772Z'), 4,false),
	/*Emily fue llevado por Mateo y luego por Valeria*/
	(3101111111, 3102222222, GEOMETRY(POINT(2,2)), GEOMETRY(POINT(1,2)), (TIMESTAMP '2019-03-01T09:00:00.772Z'), (TIMESTAMP '2019-03-01T10:30:12.772Z'), 3,false),
	(3101111111, 3103333333, GEOMETRY(POINT(3,4)), GEOMETRY(POINT(4,4)), (TIMESTAMP '2019-03-01T15:20:33.772Z'), (TIMESTAMP '2019-03-01T16:01:35.772Z'), 4,false);
