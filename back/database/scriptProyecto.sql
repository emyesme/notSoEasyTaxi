...
INSERT INTO Drive (cellPhoneDriver, plaque, date) VALUES
	...
	('3102222222', 'VCC200', (TIMESTAMP '2018-05-16 15:36:38')),
	('3102222222', 'VCD120', (TIMESTAMP '2018-12-28 16:40:00')),
	('3102222222', 'VCC200', (TIMESTAMP '2019-02-10 12:15:10')),

	/*Valeria manejaba el Mustang luego maneja el Audi*/
	('3102222222', 'VCE317', (TIMESTAMP '2018-05-16 15:36:38')),
	('3102222222', 'VCF222', (TIMESTAMP '2018-12-28 10:10:10'));
...
INSERT INTO Ask (cellphoneClient, cellphoneDriver, initialCooridnates, finalCooridnates, initialTime, finalTime, stars) VALUES
	...
	(3107307371, 3102222222, GEOMETRY(POINT(1,2)), GEOMETRY(POINT(1,3)), (TIMESTAMP '2019-03-08 08:00:12'), (TIMESTAMP '2019-03-08 08:30:12'), 5),
	(3107307371, 3102222222, GEOMETRY(POINT(1,2)), GEOMETRY(POINT(1,3)), (TIMESTAMP '2019-03-09 08:00:00'), (TIMESTAMP '2019-03-09 09:45:28'), 4),
	/*Emily fue llevado por Mateo y luego por Valeria*/
	(3101111111, 3102222222, GEOMETRY(POINT(2,2)), GEOMETRY(POINT(1,2)), (TIMESTAMP '2019-03-01 09:00:00'), (TIMESTAMP '2019-03-01 10:30:12'), 3),
	(3101111111, 3103333333, GEOMETRY(POINT(3,4)), GEOMETRY(POINT(4,4)), (TIMESTAMP '2019-03-01 15:20:33'), (TIMESTAMP '2019-03-01 16:01:35'), 4);
*/
